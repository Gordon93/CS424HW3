var ArtistForceGraph = (function () {
    ...
    ArtistForceGraph.prototype.dataArtists = function (artists) {
        var _this = this;
        console.log(artists);
        var nodeU = this.node.data(artists, function (d) { return d["id"]; });
        var div = this.div;
        nodeU.enter()
            .append("circle")
            .each(function (d) { return _this.fnodes.push({ id: d["id"], name: d["name"] }); })
            .attr("class", "node")
            .attr("r", 10)
        ...
        this.fnodes.forEach(function (d, i) { return d.index = i; });
